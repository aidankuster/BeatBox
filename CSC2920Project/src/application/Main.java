...
public class Main extends Application {
	...
	public void start(Stage stage) {
		...
		try {
			...
			// this section creates key events that release the GUI buttons that represent the 11 live drumming keys on the users keyboard
	...
	// method for playing sound, copied from Controller class
